...
class LinearMLP(nn.Module):
    ...
    def __init__(
        ...
        self.in_proj_split = [hidden_features // tp_size, hidden_features // tp_size]
        self.out_features = out_features or in_features
        self.bias = bias
        self.drop = drop
        self.activation_fn = nn.SiLU()  # TODO hardcoded remove

        self.linear1 = nn.Linear(
            self.in_features, sum(self.in_proj_split) * tp_size, bias=self.bias
        )
